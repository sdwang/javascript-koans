...
describe("About Applying What We Have Learnt", function() {
  ...
  it("given I'm allergic to nuts and hate mushrooms, it should find a pizza I can eat (functional)", function () {
      ...
      var productsICanEat = products.filter(function(x) {
        return (x.containsNuts === false) && _(x.ingredients).all(function(x) {return x !== "mushrooms"}) //!mushrooms(x.ingredients)
      });

      //could not use all() or any().  Something wrong with underscore library?
  ...
  it("should count the ingredient occurrence (functional)", function () {
    ...
    var ingredientCount2 = _(products).chain()
    .map(function(x) {return x.ingredients})
    .flatten()
    .reduce(function(count,ing) {
